...
int play(string *players, int *boardspace, int biggestobstacles, int nump, int numbs) //this functions plays the game.
{
	int *playerpos;
...
void showpos(const string *players, const int *playerpos, int nump)//shows all the players position, if user says yes.
{
	for(int i = 0; i < nump; i++)
